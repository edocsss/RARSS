...
def read_smartphone_features_data(activity_type):
    file_path = os.path.join(CONFIG.FEATURES_DATA_DIR, activity_type, CONFIG.FILE_NAME_SUFFIX + CONFIG.PREPROCESS_DATA_SOURCE_SUBJECT + '_' + CONFIG.FEATURES_DATA_RESULT['sp'])
    return read_csv_data(file_path)


def read_smartwatch_features_data(activity_type):
    file_path = os.path.join(CONFIG.FEATURES_DATA_DIR, activity_type, CONFIG.FILE_NAME_SUFFIX + CONFIG.PREPROCESS_DATA_SOURCE_SUBJECT + '_' + CONFIG.FEATURES_DATA_RESULT['sw'])
    return read_csv_data(file_path)
