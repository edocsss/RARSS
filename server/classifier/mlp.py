...
from classifier import data_util, activity_encoding
...
if __name__ == '__main__':
    kfold_data = data_util.load_kfolds_training_and_testing_data(k=5, source='sp', activities=None, onehot=True)
    accuracy_mean, accuracy_std_dev, fscore_mean, fscore_std_dev = run_cv(
        kfold_data,
        max_epoch=3000,
        alpha=0.1,
        n_hidden_layer=1,
        n_neuron_hidden_layer=20
    )